    ...
    fun data(): Collection<Array<Any?>> {
      ...
      return listOf(
        ...
        arrayOf(
          null,
          "2.39",
          "Failed to determine Java version from string: 2.39. In the settings section, choose or download another JDK"
        ),
        arrayOf(
          JDK_11.description,
          null,
          "JDK is not selected. In the settings section, choose or download some JDK with a version at least 11"
        ),
        ...
        arrayOf(
          JDK_17.description,
          null,
          "JDK is not selected. In the settings section, choose or download some JDK with a version at least 17"
        ),
        arrayOf(
          JDK_17.description,
          JDK_11.description,
          "Your Java version is 11, while it should be at least 17. In the settings section, choose or download a newer version of JDK"
        ),
        ...
        arrayOf(
          JDK_19.description,
          null,
          "JDK is not selected. In the settings section, choose or download some JDK with a version at least 19"
        ),
        arrayOf(
          JDK_19.description,
          JDK_11.description,
          "Your Java version is 11, while it should be at least 19. In the settings section, choose or download a newer version of JDK"
        ),
        arrayOf(
          JDK_19.description,
          JDK_17.description,
          "Your Java version is 17, while it should be at least 19. In the settings section, choose or download a newer version of JDK"
        ),
