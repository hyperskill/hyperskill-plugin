...
import org.hyperskill.academy.ai.debugger.kotlin.slice.DependencyDirection.BACKWARD
import org.hyperskill.academy.ai.debugger.kotlin.slice.DependencyDirection.FORWARD
...
class CodeDependencyAnalyzerTest : EduTestCase() {
  ...
  private fun PsiFile.function(name: String) =
    PsiTreeUtil.findChildrenOfType(this, KtFunction::class.java).find { it.name == name }
