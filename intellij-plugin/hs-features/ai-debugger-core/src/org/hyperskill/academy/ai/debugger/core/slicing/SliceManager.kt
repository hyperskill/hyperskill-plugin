package org.hyperskill.academy.ai.debugger.core.slicing
...
interface SliceManager {
   ...
   *
   * @param element The PSI element to start analyzing slice processing.
  ...
  companion object {
    private val EP_NAME = LanguageExtension<SliceManager>("HyperskillEducational.sliceManager")
