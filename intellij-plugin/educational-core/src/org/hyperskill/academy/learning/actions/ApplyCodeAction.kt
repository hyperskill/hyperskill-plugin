 ...
 *
 * @see [org.hyperskill.academy.learning.actions.CompareWithAnswerAction]
 */
open class ApplyCodeAction : DumbAwareAction(), CustomComponentAction {
  ...
  override fun actionPerformed(e: AnActionEvent) {
    ...
    val fileNames =
      diffRequestChain.getUserData(VIRTUAL_FILE_PATH_LIST).takeIf { !it.isNullOrEmpty() } ?: return showFailedNotification(project)
  ...
  companion object {
    ...
    @NonNls
    const val ACTION_ID: String = "HyperskillEducational.Student.ApplyCode"
