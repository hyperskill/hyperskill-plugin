...
abstract class EduVirtualFileListener(protected val project: Project) : BulkFileListener {
   ...
   * But in tests, course files usually are created by [org.hyperskill.academy.learning.EduTestCase.courseWithFiles] which triggers virtual file listener because
   * sometimes listener is initialized in `[org.hyperskill.academy.learning.EduTestCase.setUp] method and [org.hyperskill.academy.learning.EduTestCase.courseWithFiles] creates course files after it.
