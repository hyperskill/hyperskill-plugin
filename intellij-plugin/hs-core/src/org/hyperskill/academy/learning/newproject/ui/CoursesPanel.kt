...
import org.hyperskill.academy.learning.newproject.ui.filters.CoursesSearchComponent
...
abstract class CoursesPanel(
  ...
  protected open suspend fun updateCoursesAfterLogin(preserveSelection: Boolean = true) {
    ...
    // hack: selection in org.hyperskill.academy.learning.newproject.ui.coursePanel.groups.CoursesListPanel.updateModel can't scroll correctly
