  ...
  private abstract inner class FeedbackOption(val unselectedIcon: Icon, private val selectedIcon: Icon) : JButton() {
    ...
    override fun paint(g: Graphics) {
      val backgroundColor = when {
        isSelected -> EduColors.feedbackOptionSelectedBackgroundColor
        mousePosition != null -> EduColors.feedbackOptionHoverBackgroundColor
        else -> JBColor.PanelBackground
      }
      putClientProperty("JButton.backgroundColor", backgroundColor)
      foreground = if (isSelected) {
        EduColors.feedbackOptionSelectedForeground
      }
      else {
        EduColors.feedbackOptionUnselectedForeground
      }
      super.paint(g)
    }
  }
