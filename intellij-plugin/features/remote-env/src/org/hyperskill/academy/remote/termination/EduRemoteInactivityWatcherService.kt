package org.hyperskill.academy.remote.termination
...
class EduRemoteInactivityWatcherService(private val scope: CoroutineScope) {
  ...
  companion object {
    @NonNls
    private const val DELAY_SYSTEM_PROPERTY_NAME = "hyperskill.remote.ide.inactivity.termination.delay.seconds"
